...
- **Client tools:** Standalone bilingual HTML (`client/intake.html`, `validate.html`, `next.html`) — Copy/WhatsApp export.
- **Team hub:** `internal/team-hub-ar.html` — Arabic-only agency conscience (sticky index, checklist localStorage).
...
- **Client flow (3-page mini-site, private):** 01 intake → 02 validate → 03 next (PMO handoff).
...
## Hot Paths
- `internal/team-hub-ar.html` — Agency onboarding: full project conscience in Arabic.
- `client/intake.html` — Mohamed-facing Phase 0 decisions (maps to `decisions/phase0-decisions.md` D1–D9 + extras).
- `client/validate.html` — Partner validation of 10 GTM/positioning bets before build.
...
- `validate.html` claim c4 softens pivot vs MEMORY: finance stays on site, sequencing not removal.
